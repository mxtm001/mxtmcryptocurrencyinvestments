...
export default function VerificationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess("Verification approved! Your account has been verified successfully.")
      setActiveTab("status")
                    ...
                    <div className="bg-green-500/10 border border-green-500 rounded-md p-4 mb-6">
                      <div className="flex items-center">
                        ...
                        <p className="text-green-500 font-medium">
                          Your verification has been approved! Your account is now verified.
                        </p>
                      </div>
                    </div>
                  ) : (
                            ...
                            {verification.status === "approved" && (
                              <div className="mt-4 bg-green-500/10 border border-green-500 rounded-md p-3">
                                <p className="text-green-500 text-sm">
                                  ✅ Your identity has been verified successfully! You now have access to all platform
                                  features.
                                </p>
                              </div>
                            )}
